...
if __name__ == "__main__":
    ...
    system.add_fact("has_gills")
    system.add_fact("is_carnivore")
    system.add_fact("lives_in_ocean")
    ...
    system.add_rule({"antecedent": ["mammal", "has_hooves", "has_antlers", "is_herbivore"], "consequent": "deer"})
    system.add_rule({"antecedent": ["has_scales", "has_gills", "is_carnivore", "lives_in_ocean"], "consequent": "shark"})
    system.add_rule({"antecedent": ["mammal"], "consequent": "has_fur"})
    system.add_rule({"antecedent": ["mammal", "has_hooves"], "consequent": "ungulate"})

    goal = input("Enter the animal to identify (e.g., shark ): ")
